...
The example app is located in apps/example-app and is designed to help you test the update server locally using a forked version of expo-updates.
This fork adds support for dynamic configuration overrides (e.g. switching release channels at runtime).
This app should be run in release mode.

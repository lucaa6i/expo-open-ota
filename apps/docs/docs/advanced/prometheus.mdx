...
```json
{
  ...
  "panels": [
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "sum(active_users_total{platform=~\"$platform\", runtime=~\"$runtime\", branch=~\"$branch\", update=~\"$update\"})",
    ...
    },
    {
      ...
      "title": "📊 Unique Active Users by Branch",
      "type": "timeseries"
    },
    {
      "datasource": {
  ...
  "timepicker": {},
  "timezone": "",
  "title": "🚀 OTA Server Ultimate Metrics Dashboard - ?ew",

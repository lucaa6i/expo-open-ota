...
You will need to setup the private key in the server environment variables. You can follow the [keys storage guide](/docs/keys-store) to set up your keys storage solution.

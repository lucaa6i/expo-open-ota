...
You can also specify a custom build output directory using the --outputDir flag:

```bash
npx eoas publish --branch <branch-name> --channel <release-channel> --outputDir <your-dist-dir>
```
